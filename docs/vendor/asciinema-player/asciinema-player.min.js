const _AsciinemaPlayer = ((A) => {
  ...
  class Q {
    ...
    log(A) {
      for (
        let B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), Q = 1;
        Q < B;
        Q++
      )
        e[Q - 1] = arguments[Q];
      this.logger.log(`${this.prefix}${A}`, ...e);
    }
    debug(A) {
      for (
        let B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), Q = 1;
        ...
        e[Q - 1] = arguments[Q];
      this.logger.debug(`${this.prefix}${A}`, ...e);
    }
    info(A) {
      for (
        let B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), Q = 1;
        ...
        e[Q - 1] = arguments[Q];
      this.logger.info(`${this.prefix}${A}`, ...e);
    }
    warn(A) {
      for (
        let B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), Q = 1;
        ...
        e[Q - 1] = arguments[Q];
      this.logger.warn(`${this.prefix}${A}`, ...e);
    }
    error(A) {
      for (
        let B = arguments.length, e = new Array(B > 1 ? B - 1 : 0), Q = 1;
        ...
        e[Q - 1] = arguments[Q];
      this.logger.error(`${this.prefix}${A}`, ...e);
    }
  }
  let E;
  function g(A) {
  ...
  function V(A) {
    ...
    if (Array.isArray(A)) {
      ...
      let e = "[";
      B > 0 && (e += V(A[0]));
      for (let Q = 1; Q < B; Q++) e += `, ${V(A[Q])}`;
      return (e += "]"), e;
    }
    const e = /\[object ([^\]]+)\]/.exec(toString.call(A));
    let Q;
    if (!(e && e.length > 1)) return toString.call(A);
    if (((Q = e[1]), "Object" === Q))
      try {
    ...
    return (
      ...
      (() => {
        (null !== o && 0 !== o.byteLength) ||
          (o = new Uint32Array(E.memory.buffer));
        return o;
      })().subarray(A / 4, A / 4 + B)
    );
  }
  ...
  function C() {
    return (
      (null === I ||
        !0 === I.buffer.detached ||
        (void 0 === I.buffer.detached && I.buffer !== E.memory.buffer)) &&
        (I = new DataView(E.memory.buffer)),
      I
    );
  }
  function i(A, B) {
    return ((A, B) => {
      (h += B),
        h >= d &&
          ((u = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 })),
          u.decode(),
          (h = B));
      return u.decode(n().subarray(A, A + B));
    })((A >>>= 0), B);
  }
  let o = null;
  let r = null;
  function n() {
    return (
      (null !== r && 0 !== r.byteLength) ||
        (r = new Uint8Array(E.memory.buffer)),
      r
    );
  }
  function s(A) {
  ...
  function l(A, B, e) {
    if (void 0 === e) {
      const e = w.encode(A);
      const Q = B(e.length, 1) >>> 0;
      return (
        n()
          .subarray(Q, Q + e.length)
          .set(e),
        (D = e.length),
        Q
      );
    ...
    let V = 0;
    for (; V < Q; V++) {
      const B = A.charCodeAt(V);
      if (B > 127) break;
      g[E + V] = B;
    }
    if (V !== Q) {
      0 !== V && (A = A.slice(V)),
        (E = e(E, Q, (Q = V + 3 * A.length), 1) >>> 0);
      const B = n().subarray(E + V, E + Q);
      (V += w.encodeInto(A, B).written), (E = e(E, Q, V, 1) >>> 0);
    }
    return (D = V), E;
  }
  function f(A) {
  ...
  "encodeInto" in w ||
    (w.encodeInto = (A, B) => {
      const e = w.encode(A);
      return B.set(e), { read: A.length, written: e.length };
    });
  let D = 0;
  const y =
    "undefined" === typeof FinalizationRegistry
      ? { register: () => {}, unregister: () => {} }
      : new FinalizationRegistry((A) => E.__wbg_vt_free(A >>> 0, 1));
  class k {
    static __wrap(A) {
      A >>>= 0;
      const B = Object.create(k.prototype);
      return (B.__wbg_ptr = A), y.register(B, B.__wbg_ptr, B), B;
    }
    __destroy_into_raw() {
      const A = this.__wbg_ptr;
      return (this.__wbg_ptr = 0), y.unregister(this), A;
    }
    free() {
    ...
    feed(A) {
      const B = l(A, E.__wbindgen_export, E.__wbindgen_export2);
      const e = D;
      return f(E.vt_feed(this.__wbg_ptr, B, e));
    }
    resize(A, B) {
      return f(E.vt_resize(this.__wbg_ptr, A, B));
    }
    getSize() {
      try {
        const Q = E.__wbindgen_add_to_stack_pointer(-16);
        E.vt_getSize(Q, this.__wbg_ptr);
        const A = C().getInt32(Q + 0, !0);
        const B = C().getInt32(Q + 4, !0);
        const e = t(A, B).slice();
        return E.__wbindgen_export3(A, 4 * B, 4), e;
      } finally {
        E.__wbindgen_add_to_stack_pointer(16);
      }
    }
    getLine(A, B) {
      return f(E.vt_getLine(this.__wbg_ptr, A, B));
    }
    getCursor() {
      return f(E.vt_getCursor(this.__wbg_ptr));
    }
  }
  Symbol.dispose && (k.prototype[Symbol.dispose] = k.prototype.free);
  const q = new Set(["basic", "cors", "default"]);
  function p() {
    const A = { wbg: {} };
    return (
      (A.wbg.__wbg___wbindgen_debug_string_adfb662ae34724b6 = (A, B) => {
        const e = l(V(s(B)), E.__wbindgen_export, E.__wbindgen_export2);
        const Q = D;
        C().setInt32(A + 4, Q, !0), C().setInt32(A + 0, e, !0);
      }),
      (A.wbg.__wbg___wbindgen_throw_dd24417ed36fc46e = (A, B) => {
        throw new Error(i(A, B));
      }),
      (A.wbg.__wbg_new_13317ed16189158e = () => g(new Array())),
      (A.wbg.__wbg_new_4ceb6a766bf78b04 = () => g(new Object())),
      (A.wbg.__wbg_set_3f1d0b984ed272ed = (A, B, e) => {
        s(A)[f(B)] = f(e);
      }),
      (A.wbg.__wbg_set_8b6a9a61e98a8881 = (A, B, e) => {
        s(A)[B >>> 0] = f(e);
      }),
      (A.wbg.__wbindgen_cast_2241b6af4c4b2941 = (A, B) => g(i(A, B))),
      (A.wbg.__wbindgen_cast_4625c577ab2ec9ee = (A) =>
        g(BigInt.asUintN(64, A))),
      (A.wbg.__wbindgen_cast_d6cd19b81560fd6e = (A) => g(A)),
      (A.wbg.__wbindgen_object_clone_ref = (A) => g(s(A))),
  ...
  async function F(A) {
    ...
    ("string" === typeof A ||
      ...
      (A = fetch(A));
    const { instance: e, module: Q } = await (async (A, B) => {
        ...
        if ("function" === typeof WebAssembly.instantiateStreaming)
          try {
            ...
            if (
              !A.ok ||
              !q.has(A.type) ||
              "application/wasm" === A.headers.get("Content-Type")
            )
              throw B;
            console.warn(
      ...
      {
        const e = await WebAssembly.instantiate(A, B);
  ...
  const R = Object.freeze({
    ...
    initSync: (A) => {
      ...
      return (
        ...
        L(new WebAssembly.Instance(A, B), A)
      );
    },
  });
  const M = [
  ...
  class b {
    ...
    transform(A) {
      return new b(this.input, this.xfs.concat([A]));
    }
    multiplex(A, B) {
      return new b(new v(this[Symbol.iterator](), A[Symbol.iterator](), B));
    }
    toArray() {
  ...
  class v {
    constructor(A, B, e) {
      (this.left = A), (this.right = B), (this.comparator = e);
    }
    [Symbol.iterator]() {
      let A;
      let B;
    ...
    if (A instanceof Response) {
      ...
      const e = ((A) => {
        ...
        const Q = new b(B)
          ...
          .filter((A) => "[" === A[0])
          .map(JSON.parse);
        return { header: e, events: Q };
      })(B);
      if (void 0 !== e) {
        const { header: A, events: B } = e;
        if (2 === A.version) return K(A, B);
        if (3 === A.version) return T(A, B);
        throw new Error(`asciicast v${A.version} format not supported`);
      }
      {
        const A = JSON.parse(B);
        if (1 === A.version) return Y(A);
      }
    } else {
      if ("object" === typeof A && 1 === A.version) return Y(A);
      if (Array.isArray(A)) {
        const B = A[0];
        if (2 === B.version) {
          return K(B, A.slice(1, A.length));
        }
        if (3 === B.version) {
          return T(B, A.slice(1, A.length));
        }
        throw new Error(`asciicast v${B.version} format not supported`);
      }
    }
  ...
  function Y(A) {
    let B = 0;
    const e = new b(A.stdout).map((A) => ((B += A[0]), [B, "o", A[1]]));
    return { cols: A.width, rows: A.height, events: e };
  }
  function K(A, B) {
    return {
      cols: A.width,
  ...
  function T(A, B) {
    ...
    let e = 0;
    return (
      (B = B.map((A) => ((e += A[0]), [e, A[1], A[2]]))),
      {
        cols: A.term.cols,
        rows: A.term.rows,
        theme: x(A.term?.theme),
        events: B,
        idleTimeLimit: A.idle_time_limit,
      }
    );
  ...
  function x(A) {
    ...
    return B.test(e) &&
      ...
      ? { foreground: e, background: Q, palette: E.split(":") }
      : void 0;
  }
  function O(A) {
  ...
  function W(A, B, e, Q, E, g, V, t, I) {
      ...
      );
    {
      ...
      return (
        "number" === typeof (A = A ?? {})
          ? (I.debug(`using fixed time buffer (${A} ms)`), (B = (_B) => A))
          : "function" === typeof A
            ? (I.debug("using custom dynamic buffer"), (B = A({ logger: I })))
            : (I.debug("using adaptive buffer", A),
              (B = (() => {
                const { logger: A } =
                ...
                const {
                  minBufferTime: B = 50,
                  bufferLevelStep: e = 100,
                  maxBufferLevel: Q = 50,
                  transitionDuration: E = 500,
                  peakHalfLifeUp: g = 100,
                  peakHalfLifeDown: V = 1e4,
                  floorHalfLifeUp: t = 5e3,
                  floorHalfLifeDown: I = 100,
                  idealHalfLifeUp: C = 1e3,
                  idealHalfLifeDown: i = 5e3,
                  safetyMultiplier: o = 1.2,
                  minImprovementDuration: r = 3e3,
                  ...
                  return (
                    u <= B
                      ...
                      : ((L = Math.ceil(u / e)),
                        (F = 1),
                        (R = Q),
                        (p = Math.min(R, Math.max(F, L)))),
                    D > a &&
                      A.debug("buffer underrun", { latency: D, bufferTime: a }),
                    p > s
                      ? (D > a ? (s = Math.min(p, s + 3)) : (s += 1),
                        (h = n(s)),
                        (w = (h - a) / E),
                        (d = null),
          ...
          return (
            ...
            }, 0),
            {
              pushEvent(B) {
                let e = o() - 1e3 * B[0];
                e < 0 &&
                  (Q.debug(`correcting epoch by ${e} ms`), (V += e), (e = 0)),
                  (t = A(e)),
                  I.push(B);
              },
              pushText(A) {
  ...
  function X(A) {
    ...
    let E = (A) => {
      ...
      if ("ALiS" !== B) throw new Error("not an ALiS v1 live stream");
      E = V;
    };
    let g = 0;
    function V(A) {
      const B = new AA(new DataView(A));
      const e = B.getUint8();
      if (1 !== e) throw new Error(`expected reset (0x01) frame, got ${e}`);
      return t(B, A);
    }
    function t(A, e) {
      A.decodeVarUint();
      let V = A.decodeVarUint();
      (Q = V), (V /= z), (g = 0);
      const t = A.decodeVarUint();
      const C = A.decodeVarUint();
      const i = A.getUint8();
      let o;
      if (8 === i) {
        const B = 30;
        (o = _(new Uint8Array(e, A.offset, B))), A.forward(B);
      } else if (16 === i) {
        const B = 54;
        (o = _(new Uint8Array(e, A.offset, B))), A.forward(B);
      } else if (0 !== i) throw new Error(`alis: invalid theme format (${i})`);
      const r = A.decodeVarUint();
      let n;
      return (
        r > 0 && (n = B.decode(new Uint8Array(e, A.offset, r))),
        (E = I),
        { time: V, term: { size: { cols: t, rows: C }, theme: o, init: n } }
      );
    }
    function I(I) {
      const C = new AA(new DataView(I));
      const i = C.getUint8();
      return 1 === i
        ? t(C, I)
        : 111 === i
          ? ((A, e) => {
              ...
              Q += E;
              const g = A.decodeVarUint();
              const V = B.decode(new Uint8Array(e, A.offset, g));
              return [Q / z, "o", V];
            })(C, I)
          : 105 === i
            ? ((A, B) => {
                ...
                Q += E;
                const g = A.decodeVarUint();
                const V = e.decode(new Uint8Array(B, A.offset, g));
                return [Q / z, "i", V];
              })(C, I)
            : 114 === i
              ? ((A) => {
              ...
              : 109 === i
                ? ((A, B) => {
                    ...
                    const t = g++;
                    const I = Q / z;
                    const C = V.decode(new Uint8Array(B, A.offset, E));
                    return [I, "m", { index: t, time: I, label: C }];
                  })(C, I)
                : 4 === i
                  ? ((E = V), !1)
  ...
  function _(A) {
    ...
    const Q = $(A[3], A[4], A[5]);
    const E = [];
    for (let e = 2; e < B; e++) E.push($(A[3 * e], A[3 * e + 1], A[3 * e + 2]));
    return { foreground: e, background: Q, palette: E };
  }
  function $(A, B, e) {
    return `#${P(A)}${P(B)}${P(e)}`;
  }
    ...
    decodeVarUint() {
      ...
      while (e > 127)
        (e &= 127),
          ...
          (B += BigInt(7)),
          (e = this.getUint8());
      return (A += BigInt(e) << B), Number(A);
    }
  }
  function BA() {
    const A = new TextDecoder();
    let B = (Q) => {
      const E = A.decode(Q, { stream: !0 });
      const [g, V] = ((A) => {
        const B = A.match(/\x1b\[8;(\d+);(\d+)t/);
        if (null !== B)
          return [Number.parseInt(B[2], 10), Number.parseInt(B[1], 10)];
      })(E) ??
        ((A) => {
          const B = A.match(/\[.*COLUMNS="(\d{1,3})" LINES="(\d{1,3})".*\]/);
          if (null !== B)
            return [Number.parseInt(B[1], 10), Number.parseInt(B[2], 10)];
        })(E) ?? [80, 24];
      return (
        (B = e), { time: 0, term: { size: { cols: g, rows: V }, init: E } }
      );
    };
    function e(B) {
  ...
  function QA(A) {
    ...
    const B = ((A) => {
      const B = EA(A.subarray(0, 4));
      const e = EA(A.subarray(4, 8));
      return B + e / 1e6;
    })(A.subarray(0, 8));
    const e = EA(A.subarray(8, 12));
    return { time: B, data: A.subarray(12, 12 + e), len: e + 12 };
  }
  function EA(A) {
    return A[0] + 256 * A[1] + 256 * A[2] * 256 + 256 * A[3] * 256 * 256;
  }
  const gA = (async (A) => (
    await F({ module_or_path: await A.module, memory: A.memory }), R
  ))({ module: N });
  class VA {
    constructor(A) {
  ...
  class IA extends VA {
    onEnter(A) {
      const { reason: B, message: e } = A;
      this.core._dispatchEvent("idle", { message: e }),
  ...
  class sA {
      ...
      (this.logger = e.logger),
        ...
        (this.driver = ((A) => {
          ...
          if (
            ...
            if (!cA.has(A.parser))
              throw new Error(`unknown parser: ${A.parser}`);
            A.parser = cA.get(A.parser);
          }
          if (aA.has(A.driver)) {
            const B = aA.get(A.driver);
            return (e, Q) => B(A, e, Q);
          }
          throw new Error(`unsupported driver: ${JSON.stringify(A)}`);
        })(A)),
        ...
        (this.idleTimeLimit = e.idleTimeLimit),
        (this.preload = e.preload),
        (this.startAt = B(e.startAt)),
        (this.poster = this._parsePoster(e.poster)),
        (this.markers = this._normalizeMarkers(e.markers)),
        (this.pauseOnMarkers = e.pauseOnMarkers),
        (this.audioUrl = e.audioUrl),
        (this.boldIsBright = e.boldIsBright ?? !1),
    ...
    async init() {
      this.wasm = await gA;
      const { memory: A } = await this.wasm.default();
      (this.memory = A), this._initializeVt(this.cols ?? 80, this.rows ?? 24);
      const B = this._feed.bind(this);
      const e = this._resetVt.bind(this);
      const Q = this._resizeVt.bind(this);
      const E = this._setState.bind(this);
      const g =
        "npt" !== this.poster.type || this.autoPlay
          ? void 0
          : this.poster.value;
      (this.driver = this.driver(
        {
          ...
          onMarker: (A) => {
            const { index: B, time: e, label: Q } = A;
            this._dispatchEvent("marker", { index: B, time: e, label: Q });
          },
          reset: e,
          resize: Q,
          setState: E,
        ...
        (this.preload || void 0 !== g) && this._withState((A) => A.init());
      const V = {
      ...
      if (
        ...
        let B = new U();
        (this.driver.play = () => ((B = new G(this.speed)), A())),
          (this.driver.getCurrentTime = () => B.getTime());
      }
      this._dispatchEvent("ready", V),
        this.autoPlay
          ? this.play()
          : "text" === this.poster.type &&
            (this._feed(this.poster.value), (this.needsClear = !0));
    }
    play() {
      return this._clearIfNeeded(), this._withState((A) => A.play());
    }
    pause() {
      return this._withState((A) => A.pause());
    }
    togglePlay() {
      return this._clearIfNeeded(), this._withState((A) => A.togglePlay());
    }
    seek(A) {
      return (
        this._clearIfNeeded(),
        this._withState(async (B) => {
          (await B.seek(A)) && this._dispatchEvent("seeked");
        })
      );
    }
    step(A) {
      return this._clearIfNeeded(), this._withState((B) => B.step(A));
    }
    stop() {
    ...
    getLine(A, B) {
      return this.vt.getLine(A, B);
    }
    getDataView(A, B) {
      const [e, Q] = A;
      return new DataView(this.memory.buffer, e, Q * B);
    }
    getUint32Array(A) {
      const [B, e] = A;
      return new Uint32Array(this.memory.buffer, B, e);
    }
    getCursor() {
      const A = this.vt.getCursor();
      return A
        ? { col: A[0], row: A[1], visible: !0 }
        : { col: 0, row: 0, visible: !1 };
    }
    getCurrentTime() {
    ...
    _dispatchEvent(A) {
      ...
      for (const e of this.eventHandlers.get(A)) e(B);
    }
    _withState(A) {
    ...
    _setState(A) {
      ...
      if (((this.stateName = A), "playing" === A)) this.state = new CA(this);
      else if ("idle" === A) this.state = new IA(this);
      else if ("loading" === A) this.state = new iA(this);
      else if ("ended" === A) this.state = new rA(this);
      else if ("offline" === A) this.state = new oA(this);
      else {
        if ("errored" !== A) throw new Error(`invalid state: ${A}`);
        this.state = new nA(this);
      }
      return this.state.onEnter(B), this.state;
    }
    _feed(A) {
      const B = this.vt.feed(A);
      this._dispatchEvent("vtUpdate", { changedRows: B });
    }
    async _initializeDriver() {
      ...
      (this.cols = this.cols ?? A.cols ?? 80),
        ...
        void 0 !== A.poster
          ? (A.poster.forEach((A) => this.vt.feed(A)), (this.needsClear = !0))
          : "text" === this.poster.type &&
            (this.vt.feed(this.poster.value), (this.needsClear = !0)),
        ...
        this._dispatchEvent("vtUpdate", {
          size: { cols: this.cols, rows: this.rows },
          theme: A.theme ?? null,
          changedRows: Array.from({ length: this.rows }, (_A, B) => B),
        });
    }
    _clearIfNeeded() {
      this.needsClear && (this._feed("c"), (this.needsClear = !1));
    }
    _resetVt(A, B) {
      const e =
      ...
      this.logger.debug(`core: vt reset (${A}x${B})`),
        ...
        this._dispatchEvent("vtUpdate", {
          size: { cols: A, rows: B },
          theme: Q ?? null,
          changedRows: Array.from({ length: B }, (_A, B) => B),
        });
    }
    _resizeVt(A, B) {
      if (A === this.vt.cols && B === this.vt.rows) return;
      const e = this.vt.resize(A, B);
      (this.vt.cols = A),
        (this.vt.rows = B),
        this.logger.debug(`core: vt resize (${A}x${B})`),
        this._dispatchEvent("metadata", { size: { cols: A, rows: B } }),
        this._dispatchEvent("vtUpdate", {
          size: { cols: A, rows: B },
          changedRows: e,
        });
    ...
    _initializeVt(A, B) {
      this.logger.debug("vt init", { cols: A, rows: B }),
        (this.vt = this.wasm.create(A, B, 100, this.boldIsBright)),
        (this.vt.cols = A),
        (this.vt.rows = B);
    }
    _parsePoster(A) {
  ...
  const aA = new Map([
    [
      ...
      (A, B) => {
        let e;
        const { url: Q, iterations: E = 10 } = A;
        const { feed: g, setState: V } = B;
        let t = 0;
        return {
          async init() {
            const A = await S(await fetch(Q));
            const { cols: B, rows: E, events: g } = A;
            e = Array.from(g)
              .filter((A) => {
                const [_B, e, _Q] = A;
                return "o" === e;
            ...
            for (const [_A, B] of e) t += new Blob([B]).size;
            return { cols: B, rows: E, duration: V };
          },
          play() {
            const A = performance.now();
            for (let A = 0; A < E; A++) {
              for (const [_A, B] of e) g(B);
              g("c");
            }
            const B = (performance.now() - A) / 1e3;
            const Q = (t * E) / B;
            const I = ((t / 1048576) * E) / B;
            return (
    ...
    [
      ...
      (A, B, e) => {
        ...
        return {
          init: () => {
            const A = [o].concat(n());
            return { cols: t, rows: I, duration: 1440, poster: A };
          },
          play: () => (V(o), s(), (r = setInterval(s, 1e3)), !0),
          stop: () => {
            clearInterval(r);
          },
          getCurrentTime: () => {
    ...
    [
      ...
      (A, B) => {
        let e;
        let E;
        const { url: g, bufferTime: V, minFrameTime: t } = A;
        let {
          feed: I,
          reset: C,
          resize: i,
        ...
        s = new Q(s, "eventsource: ");
        let a = new U();
        function c(A) {
          void 0 !== E && E.stop(),
            (E = W(V, I, i, o, r, (A) => a.setTime(A), A, t, s));
        }
        return {
          play: () => {
            (e = new EventSource(g)),
              ...
              e.addEventListener("error", (A) => {
                s.info("errored"), s.debug({ e: A }), n("loading");
              }),
              e.addEventListener("message", (A) => {
                ...
                if (Array.isArray(B)) E.pushEvent(B);
                  ...
                  const e = B.rows ?? B.height;
                  s.debug(`vt reset (${A}x${e})`),
                    n("playing"),
                    c(B.time),
                    C(A, e, B.init ?? void 0),
                    (a = new G()),
                  ...
                  "offline" === B.state &&
                    ...
                    n("offline", { message: "Stream offline" }),
                    (a = new U()));
              }),
              e.addEventListener("done", () => {
                s.info("closed"),
                  e.close(),
                  n("ended", { message: "Stream ended" });
              });
          },
          stop: () => {
            void 0 !== E && E.stop(), void 0 !== e && e.close();
          },
    ...
    [
      ...
      (_A, B, e) => {
        ...
        const _C = () => {
          I();
          const A = String.fromCharCode(g + Math.floor(Math.random() * V));
          Q(A);
        };
    ...
    [
      ...
      (A, B, e) => {
        ...
        let G = !1;
        let U = !1;
        let J = () => performance.now() * h;
        let v = !1;
        async function S(A, B) {
          const e = await fetch(A, B);
          if (!e.ok)
            throw new Error(
              `failed fetching recording from ${A}: ${e.status} ${e.statusText}`
            );
          return e;
        }
        function Y() {
        ...
        function x(A) {
          ...
          if ("o" === e) a(Q);
            ...
            return W(), (o = 1e3 * B), u("idle", { reason: "paused" }), !0;
          return !1;
        }
        function Z() {
          T(),
            N++,
            !0 === y || ("number" === typeof y && N < y)
              ? ((M = 0), (i = J()), a("c"), _(), Y(), s && (s.currentTime = 0))
              : ((o = 1e3 * t), u("ended"), s?.pause());
        }
        function W() {
          return (U = !1), s?.pause(), !C || (T(), (o = J() - i), !0);
        }
        async function j() {
          s &&
            !n &&
            (() => {
              n = new AudioContext({ latencyHint: "interactive" });
              const A = n.createMediaElementSource(s);
              A.connect(n.destination), (J = $);
            })(),
            (i = J() - o),
            (o = null),
            Y(),
              ...
              : ">>" === A
                ...
                : "<<<" === A
                  ...
                  : ">>>" === A
                    ...
                    : "%" === A[A.length - 1] &&
                      (A =
                        (Number.parseFloat(A.substring(0, A.length - 1)) /
                          100) *
                        t);
          else if ("object" === typeof A)
            if ("prev" === A.marker)
              (A = X(e) ?? 0), B && e - A < 1 && (A = X(A) ?? 0);
              ...
              A =
                ((A) => {
                  ...
                  let e = V.length - 1;
                  let Q = V[e];
                  while (Q && Q[0] > A) (B = Q[0]), (Q = V[--e]);
                  return B;
                })(e) ?? t;
            else if ("number" === typeof A.marker) {
              const B = V[A.marker];
              if (void 0 === B)
                throw new Error(`invalid marker index: ${A.marker}`);
              A = B[0];
            }
          const Q = Math.min(Math.max(A, 0), t);
          if (1e3 * Q === o) return !1;
          Q < m && (a("c"), _(), (M = 0), (m = 0));
          let E = g[M];
          while (E && E[0] <= Q)
            ("o" !== E[1] && "r" !== E[1]) || x(E), (m = E[0]), (E = g[++M]);
          return (
            (o = 1e3 * Q),
            (I = null),
            s && v && (s.currentTime = Q / h),
            B ? await j() : void 0 === g[M] && Z(),
            !0
          );
        }
        function X(A) {
        ...
        function $() {
          if (!n)
            throw new Error("audio context not started - can't tell time!");
          const { contextTime: A, performanceTime: B } = n.getOutputTimestamp();
          return 0 === B ? 1e3 * A : 1e3 * A + (performance.now() - B);
        }
        function P() {
          if (
            (d.debug("audio buffering"),
            (G = !0),
            (U = !!C),
            (r = setTimeout(() => u("loading"), 1e3)),
            !C)
          )
            return !0;
          d.debug("pausing session playback"), T(), (o = J() - i);
        }
        function AA() {
          d.debug("audio resumed"),
            clearTimeout(r),
            u("playing"),
            G &&
              ((G = !1),
              U &&
                (d.debug("resuming session playback"),
                (i = J() - o),
                (o = null),
                Y()));
        }
        return {
            ...
            try {
              let B = (async (A, B, e) => {
                ...
                const s = await (async (A) => {
                  let { url: B, data: e, fetchOpts: Q = {} } = A;
                  if ("string" === typeof B) return await S(B, Q);
                  if (Array.isArray(B))
                    return await Promise.all(B.map((A) => S(A, Q)));
                  if (void 0 !== e) {
                    "function" === typeof e && (e = e()),
                      e instanceof Promise || (e = Promise.resolve(e));
                    const A = await e;
                  ...
                  throw new Error(
                    "failed fetching recording file: url/data missing in src"
                  );
                })(A);
                const a = ((A, B, e) => {
                  let {
                  ...
                  (I = I.transform(
                    ((A) => {
                      ...
                      return (Q) => {
                        ...
                        return {
                          ...
                          flush: () => {
                            void 0 !== B && (Q(B), g++),
                              A.debug(`batched ${E} frames to ${g} frames`);
                          },
                        };
                      };
                    })(B, g)
                    ...
                    void 0 !== t &&
                      ((t = new b(t).map(O)),
                      (I = I.filter((A) => "m" !== A[1])
                        .multiplex(t, (A, B) => A[0] < B[0])
                        .map(H())));
                  (I = I.toArray()),
                    void 0 !== V &&
                      ((I = I.map((A) =>
                        "i" === A[1] ? [A[0] + V, A[1], A[2]] : A
                      )),
                      I.sort((A, B) => A[0] - B[0]));
                  const i = I[I.length - 1][0];
                  const o = Q - C.offset;
                  return {
                    ...A,
                    events: I,
              ...
              })(A, d, { idleTimeLimit: w, startAt: D, markers_: q });
              const e = await (async (A) => {
                if (!A) return !1;
                (s = await (async (A) => {
                  const B = new Audio();
                  let e;
                  ...
                  const Q = new Promise((A) => {
                    e = A;
                  });
                  function E() {
                    e(), B.removeEventListener("canplay", E);
                  }
                  return (
                  ...
                  v
                    ? (s.addEventListener("playing", AA),
                      s.addEventListener("waiting", P))
                    : d.warn(
                        `audio is not seekable - you must enable range request support on the server providing ${s.src} for audio seeking to work`
                      );
                return !0;
              })(R);
              return (B = await B), { ...B, hasAudio: e };
            } finally {
              clearTimeout(B);
            }
          },
          play: async () => {
            if (C) throw new Error("already playing");
            if (void 0 === g[M]) throw new Error("already ended");
            return null !== I && z(I), await j(), !0;
          },
          pause: W,
          seek: z,
          step: (A) => {
            ...
            if ((void 0 === A && (A = 1), A > 0)) {
              ...
              B = g[Q];
              for (let E = 0; E < A; E++) {
                while (void 0 !== B && "o" !== B[1]) B = g[++Q];
                void 0 !== B && "o" === B[1] && (e = Q);
              }
            } else {
              let Q = Math.max(M - 2, 0);
              B = g[Q];
              for (let E = A; E < 0; E++) {
                while (void 0 !== B && "o" !== B[1]) B = g[--Q];
                void 0 !== B && "o" === B[1] && (e = Q);
            ...
            if (void 0 !== e) {
              while (M <= e)
                (B = g[M++]), ("o" !== B[1] && "r" !== B[1]) || x(B);
              (m = B[0]),
                (o = 1e3 * m),
                (I = null),
                s && v && (s.currentTime = m / h),
                void 0 === g[e + 1] && Z();
            }
          },
          restart: async () => {
            if (C) throw new Error("still playing");
            if (void 0 !== g[M]) throw new Error("not ended");
          ...
          getCurrentTime: () => (C ? (J() - i) / 1e3 : (o ?? 0) / 1e3),
        };
      },
    ],
    [
      ...
      (A, B, e) => {
        ...
        function k() {
          (E = new WebSocket(V, [
                    ...
                    ? (E.onmessage = q(
                        (() => {
                          let A = (e) => {
                            ...
                            return (
                              (A = B),
                              {
                                time: 0,
                                term: {
                                  size: { cols: Q.width, rows: Q.height },
                                },
                              }
                            );
                          };
                          function B(A) {
                            ...
                            if ("r" === B[1]) {
                              const [A, e] = B[2].split("x");
                              return [
                                B[0],
                                "r",
                                {
                                  cols: Number.parseInt(A, 10),
                                  rows: Number.parseInt(e, 10),
                                },
                              ];
                            }
                            return B;
                          ...
                          (() => {
                            let A = (B) => {
                              ...
                              return (
                                Q.term.theme &&
                                  (E.theme = {
                                    foreground: Q.term.theme.fg,
                                    background: Q.term.theme.bg,
                                    palette: Q.term.theme.palette.split(":"),
                                  }),
                                { time: 0, term: E }
                              );
                            };
            ...
            (E.onclose = (A) => {
              if (
                (clearTimeout(u), F(), D || 1e3 === A.code || 1005 === A.code)
              )
          ...
          return (
            ...
            (B) => {
              try {
                const e = A(B.data);
                if (g)
                  if (Array.isArray(e)) g.pushEvent(e);
                  else if ("string" === typeof e) g.pushText(e);
                  else if ("object" !== typeof e || Array.isArray(e)) {
                    if (!1 === e) L();
                    else if (void 0 !== e)
                      throw new Error(
                        `unexpected value from protocol handler: ${e}`
                      );
                  } else p(e);
                else if ("object" !== typeof e || Array.isArray(e)) {
                  if (void 0 !== e)
                    throw (
                      (clearTimeout(u),
                      new Error(`unexpected value from protocol handler: ${e}`))
                    );
                  clearTimeout(u), (u = setTimeout(L, 1e3));
                } else p(e), clearTimeout(u);
              } catch (A) {
                throw (E.close(), A);
              }
            }
        ...
        function p(A) {
          const { time: B, term: e } = A;
          const { size: Q, init: E, theme: V } = e;
          const { cols: I, rows: l } = Q;
          c.info(`stream reset (${I}x${l} @${B})`),
            a("playing"),
            F(),
            (g = W(t, i, r, n, s, (A) => h.setTime(A), B, C, c)),
            o(I, l, E, V),
            (h = new G()),
            (y = !0),
            "number" === typeof B && h.setTime(B);
        }
        function L() {
          F(),
            y
        ...
        return {
          ...
          stop: () => {
            (D = !0), F(), void 0 !== E && E.close(), d?.pause();
          },
          mute: () => {
            if (d) return (d.muted = !0), !0;
          },
          unmute: () => {
            if (d) return (d.muted = !1), !0;
          },
          getCurrentTime: () => h.getTime(),
        };
      },
    ],
  ]);
  const cA = new Map([
    ...
    [
      ...
      async (A, B) => {
        const { encoding: e } = B;
        const Q = new TextDecoder(e);
        let E;
        let g;
        let V = (await A[0].text())
          .split("\n")
          .filter((A) => A.length > 0)
          .map((A) => A.split(" "));
        V[0].length < 3 && (V = V.map((A) => ["O", A[0], A[1]]));
        const t = await A[1].arrayBuffer();
        const I = new Uint8Array(t);
        const C = I.findIndex((A) => 10 === A) + 1;
        const i = Q.decode(I.subarray(0, C)).match(
          /COLUMNS="(\d+)" LINES="(\d+)"/
        );
        null !== i &&
          ((E = Number.parseInt(i[1], 10)), (g = Number.parseInt(i[2], 10)));
        const o = { array: I, cursor: C };
        let r = o;
        if (void 0 !== A[2]) {
          const B = await A[2].arrayBuffer();
          r = { array: new Uint8Array(B), cursor: C };
        }
        const n = [];
        let s = 0;
        for (const A of V)
          if (((s += Number.parseFloat(A[1])), "O" === A[0])) {
            const B = Number.parseInt(A[2], 10);
            const e = o.array.subarray(o.cursor, o.cursor + B);
            const E = Q.decode(e);
            n.push([s, "o", E]), (o.cursor += B);
          } else if ("I" === A[0]) {
            const B = Number.parseInt(A[2], 10);
            const e = r.array.subarray(r.cursor, r.cursor + B);
            const E = Q.decode(e);
            n.push([s, "i", E]), (r.cursor += B);
          } else if ("S" === A[0] && "SIGWINCH" === A[2]) {
            const B = Number.parseInt(A[4].slice(5), 10);
            const e = Number.parseInt(A[3].slice(5), 10);
            n.push([s, "r", `${B}x${e}`]);
          } else
            "H" === A[0] && "COLUMNS" === A[2]
              ? (E = Number.parseInt(A[3], 10))
              : "H" === A[0] &&
                "LINES" === A[2] &&
                (g = Number.parseInt(A[3], 10));
        return (E = E ?? 80), (g = g ?? 24), { cols: E, rows: g, events: n };
      },
    ],
    [
      "ttyrec",
      async (A, B) => {
        ...
        const V = QA(g);
        const t = V.time;
        const I = Q.decode(V.data).match(/\x1b\[8;(\d+);(\d+)t/);
        const C = [];
        let i = 80;
        let o = 24;
        null !== I &&
          ((i = Number.parseInt(I[2], 10)), (o = Number.parseInt(I[1], 10)));
        let r = 0;
        let n = QA(g);
        while (void 0 !== n) {
          const A = n.time - t;
          const B = Q.decode(n.data);
          C.push([A, "o", B]), (r += n.len), (n = QA(g.subarray(r)));
        }
        return { cols: i, rows: o, events: C };
      },
    ],
  ]);
  const lA = Symbol("solid-proxy");
  const fA = Symbol("solid-track");
  const uA = { equals: (A, B) => A === B };
  let dA = XA;
  const hA = 1;
  const wA = 2;
  const DA = { owned: null, cleanups: null, context: null, owner: null };
  let yA = null;
  const kA = null;
  let qA = null;
  let pA = null;
  ...
  function MA(A, B) {
    const e = {
      ...
      observers: null,
      observerSlots: null,
      comparator: (B = B ? Object.assign({}, uA, B) : uA).equals || void 0,
    };
    return [
      OA.bind(e),
      (A) => ("function" === typeof A && (A = A(e.value)), HA(e, A)),
    ];
  }
  function mA(A, B, _e) {
    ZA(WA(A, B, !1, hA));
  ...
  function GA(A, B, e) {
    ...
    return (
      (Q.observers = null),
      (Q.observerSlots = null),
      (Q.comparator = e.equals || void 0),
      ZA(Q),
      OA.bind(Q)
    );
  }
  ...
  function vA(A) {
    return (
      null === yA ||
        (null === yA.cleanups ? (yA.cleanups = [A]) : yA.cleanups.push(A)),
      A
    );
  }
  function SA() {
  ...
  function OA() {
    if (this.sources && this.state)
      if (this.state === hA) ZA(this);
      else {
        const A = pA;
        (pA = null), zA(() => $A(this), !1), (pA = A);
      }
    if (qA) {
        ...
        A.observers?.length &&
          zA(() => {
            for (let B = 0; B < A.observers.length; B += 1) {
              const e = A.observers[B];
              const Q = kA?.running;
              Q && kA.disposed.has(e),
                (Q ? e.tState : e.state) ||
                  (e.pure ? pA.push(e) : LA.push(e), e.observers && PA(e)),
                Q || (e.state = hA);
            }
            if (pA.length > 1e6) throw ((pA = []), new Error());
          }, !1)),
      B
    );
  }
  function ZA(A) {
    ...
    !((A, B, e) => {
      ...
      try {
        ...
        return (
          A.pure && ((A.state = hA), A.owned?.forEach(AB), (A.owned = null)),
          (A.updatedAt = e + 1),
          BB(B)
        );
      } finally {
      ...
      (!A.updatedAt || A.updatedAt <= e) &&
        (null != A.updatedAt && "observers" in A ? HA(A, Q) : (A.value = Q),
        (A.updatedAt = e));
    })(A, A.value, B);
  }
  function WA(A, B, e, Q, _E) {
    const g = {
      fn: A,
      state: Q,
      updatedAt: null,
      ...
      value: B,
      owner: yA,
      context: yA ? yA.context : null,
      pure: e,
    };
    return (
      null === yA ||
        (yA !== DA && (yA.owned ? yA.owned.push(g) : (yA.owned = [g]))),
      g
    );
  }
  function jA(A) {
    if (0 === A.state) return;
    if (A.state === wA) return $A(A);
    if (A.suspense && bA(A.suspense.inFallback))
      return A.suspense.effects.push(A);
    const B = [A];
    while ((A = A.owner) && (!A.updatedAt || A.updatedAt < FA))
      A.state && B.push(A);
    for (let e = B.length - 1; e >= 0; e--)
      if ((A = B[e]).state === hA) ZA(A);
      else if (A.state === wA) {
        const e = pA;
        (pA = null), zA(() => $A(A, B[0]), !1), (pA = e);
      }
  }
  function zA(A, B) {
    if (pA) return A();
    ...
    try {
      ...
      return (
        ((A) => {
          ...
          if (A) return;
          const B = LA;
          (LA = null), B.length && zA(() => dA(B), !1);
        })(e),
        B
      );
    } catch (A) {
      e || (LA = null), (pA = null), BB(A);
    }
  }
  function XA(A) {
    for (let B = 0; B < A.length; B++) jA(A[B]);
  }
  function _A(A) {
    let B;
    let e = 0;
    ...
    for (B = 0; B < e; B++) jA(A[B]);
  }
  function $A(A, B) {
    A.state = 0;
    for (let e = 0; e < A.sources.length; e += 1) {
      const Q = A.sources[e];
      if (Q.sources) {
        const A = Q.state;
        A === hA
          ? Q !== B && (!Q.updatedAt || Q.updatedAt < FA) && jA(Q)
          : A === wA && $A(Q, B);
      }
    }
  }
  ...
  function AB(A) {
    let B;
    if (A.sources)
      while (A.sources.length) {
        const B = A.sources.pop();
        const e = A.sourceSlots.pop();
        const Q = B.observers;
        if (Q?.length) {
          const A = Q.pop();
          const E = B.observerSlots.pop();
          e < Q.length &&
            ((A.sourceSlots[E] = e), (Q[e] = A), (B.observerSlots[e] = E));
        }
      }
    if (A.tOwned) {
      for (B = A.tOwned.length - 1; B >= 0; B--) AB(A.tOwned[B]);
      A.tOwned = undefined;
    }
    if (A.owned) {
      for (B = A.owned.length - 1; B >= 0; B--) AB(A.owned[B]);
      A.owned = null;
    }
    if (A.cleanups) {
  ...
  function eB(A) {
    if ("function" === typeof A && !A.length) return eB(A());
    if (Array.isArray(A)) {
      const B = [];
      for (let e = 0; e < A.length; e++) {
        const Q = eB(A[e]);
        Array.isArray(Q) ? B.push.apply(B, Q) : B.push(Q);
      }
      return B;
    }
    return A;
  }
  const QB = Symbol("fallback");
  function EB(A) {
              ...
              bA(() => {
                ...
                if (0 === o)
                  ...
                  for (
                    ...
                    (n[f] = E[l]), (s[f] = g[l]), t && (a[f] = t[l]);
                  for (A = new Map(), B = new Array(f + 1), C = f; C >= c; C--)
                    (u = i[C]),
                      (I = A.get(u)),
                      (B[C] = void 0 === I ? -1 : I),
                      A.set(u, C);
  ...
  function IB(A) {
    const B = A.keyed;
    const e = GA(() => A.when, void 0, void 0);
    const Q = B ? e : GA(e, void 0, { equals: (A, B) => !A === !B });
    return GA(
      () => {
        const E = Q();
        if (E) {
          const g = A.children;
          return "function" === typeof g && g.length > 0
            ? bA(() =>
                g(
                  B
                    ? E
                    : () => {
                        if (!bA(Q)) throw VB("Show");
                        return e();
                      }
                )
              )
  ...
  function CB(A) {
    ...
    const e = GA(() => {
      ...
      for (let A = 0; A < e.length; A++) {
        ...
        const E = e[A];
        const g = Q;
        const V = GA(() => (g() ? void 0 : E.when), void 0, void 0);
        const t = E.keyed ? V : GA(V, void 0, { equals: (A, B) => !A === !B });
        Q = () => g() || (t() ? [B, V, E] : void 0);
      }
      return Q;
    });
  ...
  const oB = "_$DX_DELEGATE";
  function rB(A, B, _e, _Q) {
    let E;
    const g = () => {
      const B = document.createElement("template");
      return (B.innerHTML = A), B.content.firstChild;
    };
    const V = B
      ? () => bA(() => document.importNode(E || (E = g()), !0))
      : () => (E || (E = g())).cloneNode(!0);
    return (V.cloneNode = V), V;
  }
  function nB(A, B = window.document) {
    const e = B[oB] || (B[oB] = new Set());
    for (let Q = 0, E = A.length; Q < E; Q++) {
      const E = A[Q];
      e.has(E) || (e.add(E), B.addEventListener(E, uB));
    }
  }
  function sB(A, B, e) {
    null == e ? A.removeAttribute(B) : A.setAttribute(B, e);
  }
  function aB(A, B, e, _Q) {
    Array.isArray(e)
      ? ((A[`$$${B}`] = e[0]), (A[`$$${B}Data`] = e[1]))
      : (A[`$$${B}`] = e);
  }
  function cB(A, B, e) {
    if (!B) return e ? sB(A, "style") : B;
    const Q = A.style;
    if ("string" === typeof B) return (Q.cssText = B);
    let E;
    let g;
    for (g in ("string" === typeof e && (Q.cssText = e = void 0),
    e || (e = {}),
    B || (B = {}),
    e))
      null == B[g] && Q.removeProperty(g), delete e[g];
    for (g in B) (E = B[g]), E !== e[g] && (Q.setProperty(g, E), (e[g] = E));
    return e;
  }
  function lB(A, B, e) {
    return bA(() => A(B, e));
  ...
  function fB(A, B, e, Q) {
    if ((void 0 === e || Q || (Q = []), "function" !== typeof B))
      return dB(A, B, Q, e);
    mA((Q) => dB(A, B(), Q, e), Q);
  }
  function uB(A) {
    ...
    const V = () => {
      ...
      if (Q && !B.disabled) {
        const E = B[`${e}Data`];
        if ((void 0 !== E ? Q.call(B, E, A) : Q.call(B, A), A.cancelBubble))
          return;
      }
      return (
        B.host &&
    ...
    const t = () => {
      while (V() && (B = B._$host || B.parentNode || B.host));
    };
    if (
      ...
      g(e[0]);
      for (let A = 0; A < e.length - 2 && ((B = e[A]), V()); A++) {
        if (B._$host) {
          (B = B._$host), t();
          break;
        }
  ...
  function dB(A, B, e, Q, E) {
    while ("function" === typeof e) e = e();
    if (B === e) return e;
    const g = typeof B;
    const V = void 0 !== Q;
    if (
      ((A = (V && e[0] && e[0].parentNode) || A),
      "string" === g || "number" === g)
    ) {
      if ("number" === g && (B = B.toString()) === e) return e;
      if (V) {
        let E = e[0];
        E && 3 === E.nodeType
          ? E.data !== B && (E.data = B)
        ...
        e =
          "" !== e && "string" === typeof e
            ? (A.firstChild.data = B)
            : (A.textContent = B);
    } else if (null == B || "boolean" === g) e = DB(A, e, Q);
    else {
      if ("function" === g)
        return (
          mA(() => {
      ...
      if (Array.isArray(B)) {
        ...
        if (hB(g, B, e, E)) return mA(() => (e = dB(A, g, e, Q, !0))), () => e;
        if (0 === g.length) {
          if (((e = DB(A, e, Q)), V)) return e;
        } else
          t
            ? 0 === e.length
              ? wB(A, g, Q)
              : ((A, B, e) => {
                  ...
                  let V = 0;
                  let t = 0;
                  const I = B[E - 1].nextSibling;
                  let C = null;
                  while (V < E || t < g)
                    if (B[V] !== e[t]) {
                      while (B[E - 1] === e[g - 1]) E--, g--;
                      if (E === V) {
                        const B =
                          g < Q ? (t ? e[t - 1].nextSibling : e[g - t]) : I;
                        while (t < g) A.insertBefore(e[t++], B);
                      } else if (g === t)
                        while (V < E) C?.has(B[V]) || B[V].remove(), V++;
                      else if (B[V] === e[g - 1] && e[t] === B[E - 1]) {
                        const Q = B[--E].nextSibling;
                        A.insertBefore(e[t++], B[V++].nextSibling),
                          A.insertBefore(e[--g], Q),
                          (B[E] = e[g]);
                      } else {
                        if (!C) {
                          C = new Map();
                          let A = t;
                          while (A < g) C.set(e[A], A++);
                        }
                        const Q = C.get(B[V]);
                        if (null != Q)
                          if (t < Q && Q < g) {
                            ...
                            if (o > Q - t) {
                              const E = B[V];
                              while (t < Q) A.insertBefore(e[t++], E);
                            } else A.replaceChild(e[t++], B[V++]);
                          } else V++;
                        else B[V++].remove();
                      }
                    } else V++, t++;
        ...
        if (Array.isArray(e)) {
          if (V) return (e = DB(A, e, Q, B));
          DB(A, e, null, B);
        } else
          null != e && "" !== e && A.firstChild
  ...
  function hB(A, B, e, Q) {
    ...
    for (let g = 0, V = B.length; g < V; g++) {
      ...
      const I = e?.[A.length];
      if (null == t || !0 === t || !1 === t);
      else if ("object" === (V = typeof t) && t.nodeType) A.push(t);
      else if (Array.isArray(t)) E = hB(A, t, I) || E;
      else if ("function" === V)
        if (Q) {
          while ("function" === typeof t) t = t();
          E =
            hB(A, Array.isArray(t) ? t : [t], Array.isArray(I) ? I : [I]) || E;
        } else A.push(t), (E = !0);
      else {
        const B = String(t);
        I && 3 === I.nodeType && I.data === B
          ? A.push(I)
  ...
  function wB(A, B, e = null) {
    for (let Q = 0, E = B.length; Q < E; Q++) A.insertBefore(B[Q], e);
  }
  function DB(A, B, e, Q) {
    if (void 0 === e) return (A.textContent = "");
    const E = Q || document.createTextNode("");
    if (B.length) {
      let Q = !1;
      for (let g = B.length - 1; g >= 0; g--) {
        const V = B[g];
        if (E !== V) {
          const B = V.parentNode === A;
          Q || g
            ? B && V.remove()
            : B
              ? A.replaceChild(E, V)
    ...
    } else A.insertBefore(E, e);
    return [E];
  }
  const yB = Symbol("store-raw");
  const kB = Symbol("store-node");
  const qB = Symbol("store-has");
  const pB = Symbol("store-self");
  function LB(A) {
    let B = A[lA];
    if (
      !B &&
      (Object.defineProperty(A, lA, { value: (B = new Proxy(A, GB)) }),
      !Array.isArray(A))
    ) {
      const e = Object.keys(A);
      const Q = Object.getOwnPropertyDescriptors(A);
      for (let E = 0, g = e.length; E < g; E++) {
        const g = e[E];
        Q[g].get &&
          Object.defineProperty(A, g, {
            enumerable: Q[g].enumerable,
            get: Q[g].get.bind(B),
          });
      }
    }
  ...
  function RB(A, B = new Set()) {
    let e;
    let Q;
    let E;
    let g;
    if ((e = null != A && A[yB])) return e;
    if (!FB(A) || B.has(A)) return A;
    if (Array.isArray(A)) {
      Object.isFrozen(A) ? (A = A.slice(0)) : B.add(A);
      for (let e = 0, g = A.length; e < g; e++)
        (E = A[e]), (Q = RB(E, B)) !== E && (A[e] = Q);
    } else {
      Object.isFrozen(A) ? (A = Object.assign({}, A)) : B.add(A);
      const e = Object.keys(A);
      const V = Object.getOwnPropertyDescriptors(A);
      for (let t = 0, I = e.length; t < I; t++)
        (g = e[t]),
          V[g].get || ((E = A[g]), (Q = RB(E, B)) !== E && (A[g] = Q));
    }
    return A;
  }
  function MB(A, B) {
    let e = A[B];
    return (
      e || Object.defineProperty(A, B, { value: (e = Object.create(null)) }), e
    );
  }
  function mB(A, B, e) {
    if (A[B]) return A[B];
    const [Q, E] = MA(e, { equals: !1, internal: !0 });
    return (Q.$ = E), (A[B] = Q);
  }
  function NB(A) {
    SA() && mB(MB(A, kB), pB)();
  ...
  const GB = {
    get(A, B, e) {
      if (B === yB) return A;
      if (B === lA) return e;
      if (B === fA) return NB(A), e;
      const Q = MB(A, kB);
      const E = Q[B];
      let g = E ? E() : A[B];
      if (B === kB || B === qB || "__proto__" === B) return g;
      if (!E) {
        const e = Object.getOwnPropertyDescriptor(A, B);
        !SA() ||
          ("function" === typeof g && !A.hasOwnProperty(B)) ||
          e?.get ||
          (g = mB(Q, B, g)());
      }
      return FB(g) ? LB(g) : g;
    ...
    has: (A, B) =>
      ...
      B === qB ||
      "__proto__" === B ||
      (SA() && mB(MB(A, qB), B)(), B in A),
    set: () => !0,
    deleteProperty: () => !0,
    ownKeys: (A) => (NB(A), Reflect.ownKeys(A)),
    getOwnPropertyDescriptor: (A, B) => {
      const e = Reflect.getOwnPropertyDescriptor(A, B);
      return e && !e.get && e.configurable && B !== lA && B !== kB
        ? ((e.value = undefined),
          (e.writable = undefined),
          (e.get = () => A[lA][B]),
          e)
        : e;
    },
  };
  function UB(A, B, e, Q = !1) {
    if (!Q && A[B] === e) return;
    const E = A[B];
    const g = A.length;
    void 0 === e
      ? (delete A[B], A[qB]?.[B] && void 0 !== E && A[qB][B].$())
      : ((A[B] = e), A[qB]?.[B] && void 0 === E && A[qB][B].$());
    let V;
    const t = MB(A, kB);
    if (
      ((V = mB(t, B, E)) && V.$(() => e), Array.isArray(A) && A.length !== g)
    ) {
      for (let B = A.length; B < g; B++) (V = t[B]) && V.$();
      (V = mB(t, "length", g)) && V.$(A.length);
    }
    (V = t[pB]) && V.$();
  }
  function bB(A, B) {
  ...
  function JB(A, B, e = []) {
    ...
    if (B.length > 1) {
      ...
      if (Array.isArray(Q)) {
        for (let E = 0; E < Q.length; E++) JB(A, [Q[E]].concat(B), e);
        return;
      }
      if (V && "function" === g) {
        for (let E = 0; E < A.length; E++)
          Q(A[E], E) && JB(A, [E].concat(B), e);
        return;
      }
      if (V && "object" === g) {
        const { from: E = 0, to: g = A.length - 1, by: V = 1 } = Q;
        for (let Q = E; Q <= g; Q += V) JB(A, [Q].concat(B), e);
        return;
      }
      if (B.length > 1) return void JB(A[Q], B, [Q].concat(e));
      (E = A[Q]), (e = [Q].concat(e));
    }
    let g = B[0];
    ("function" === typeof g && ((g = g(E, e)), g === E)) ||
      (void 0 === Q && null == g) ||
      ((g = RB(g)),
      void 0 === Q || (FB(E) && FB(g) && !Array.isArray(g))
        ? bB(E, g)
        : UB(A, Q, g));
  }
  function vB(...[A, _B]) {
    const e = RB(A || {});
    const Q = Array.isArray(e);
    return [
      LB(e),
      (...A) => {
        UA(() => {
  ...
  function KB(A, B) {
    const e = bA(A);
    const Q = e ? [e] : [];
    const { onEnter: E = YB, onExit: g = YB } = B;
    const [V, t] = MA(B.appear ? [] : Q);
    const [I] = [KA, YA];
    let C;
    let i = !1;
    function o(A, B) {
  ...
  const TB = (A) => A instanceof Element;
  function xB(A, B) {
    if (B(A)) return A;
    if ("function" === typeof A && !A.length) return xB(A(), B);
    if (Array.isArray(A))
      for (const e of A) {
        const A = xB(e, B);
        if (A) return A;
  ...
  const ZB = { inout: "in-out", outin: "out-in" };
  const WB = (A) => {
    const B = ((A) =>
      GA(() => {
        const B = A.name || "s";
    ...
    return KB(
      OB(() => A.children),
      {
        ...
        onEnter(e, Q) {
          !((A, B, e, Q) => {
            const { onBeforeEnter: E, onEnter: g, onAfterEnter: V } = B;
            function t(B) {
              (B && B.target !== e) ||
                (Q?.(),
                e.removeEventListener("transitionend", t),
                e.removeEventListener("animationend", t),
                e.classList.remove(...A.enterActive),
                e.classList.remove(...A.enterTo),
                V?.(e));
            }
            E?.(e),
              e.classList.add(...A.enter),
              e.classList.add(...A.enterActive),
              queueMicrotask(() => {
                if (!e.parentNode) return Q?.();
                g?.(e, () => t());
              }),
              HB(() => {
                e.classList.remove(...A.enter),
                  e.classList.add(...A.enterTo),
                  (!g || g.length < 2) &&
        ...
        onExit(e, Q) {
          !((A, B, e, Q) => {
            const { onBeforeExit: E, onExit: g, onAfterExit: V } = B;
            if (!e.parentNode) return Q?.();
            function t(B) {
              (B && B.target !== e) ||
                (Q?.(),
                e.removeEventListener("transitionend", t),
                e.removeEventListener("animationend", t),
                e.classList.remove(...A.exitActive),
                e.classList.remove(...A.exitTo),
                V?.(e));
            }
            E?.(e),
              e.classList.add(...A.exit),
              e.classList.add(...A.exitActive),
              g?.(e, () => t()),
              HB(() => {
                e.classList.remove(...A.exit),
                  e.classList.add(...A.exitTo),
                  (!g || g.length < 2) &&
                    (e.addEventListener("transitionend", t),
                    e.addEventListener("animationend", t));
              });
  ...
  const jB = rB(
    '<div class="ap-term"><canvas></canvas><svg class="ap-term-symbols" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" width="100%" height="100%" aria-hidden="true"><defs></defs><g></g></svg><pre class="ap-term-text" aria-live="off" tabindex="0"></pre></div>',
    12
  );
  const zB = "http://www.w3.org/2000/svg";
  const XB = 24;
  const _B = (A) => {
    const B = A.core;
    const e = [];
    ...
    const [i, o] = MA($B(Ee));
    const r = () => A.lineHeight ?? 1.3333333333;
    const [n, s] = MA(!0);
    const a = GA(() => n() || F);
    const c = GA(() => ({
      width: `${I().cols}ch`,
    ...
    let k;
    let q;
    let p = { col: 0, row: 0, visible: !1 };
    const L = { size: void 0, theme: void 0, rows: new Set() };
    let F = !1;
    function R(e) {
      const { size: Q, theme: E, changedRows: g } = e;
      let V = !1;
      if (void 0 !== g) for (const A of g) L.rows.add(A), (F = !0), (V = !0);
      if (void 0 !== E && A.preferEmbeddedTheme) {
        L.theme = E;
        for (let A = 0; A < I().rows; A++) L.rows.add(A);
      }
      const t = B.getCursor();
      if (
        ((t.visible === p.visible && t.col === p.col && t.row === p.row) ||
          (p.visible && L.rows.add(p.row),
          t.visible && L.rows.add(t.row),
          (p = t),
          (F = !0),
          (V = !0)),
        void 0 !== Q)
        ...
        L.size = Q;
        for (const A of L.rows) A >= Q.rows && L.rows.delete(A);
      }
      V && p.visible && L.rows.add(p.row), m();
    }
    function M() {
      s((A) => (A || (F = !1), !A));
    }
    function m() {
      void 0 === y && (y = requestAnimationFrame(N));
    }
    function N() {
      y = void 0;
      const { size: B, theme: e, rows: Q } = L;
      UA(() => {
        void 0 !== B &&
          (!((A) => {
            const { cols: B, rows: e } = A;
            (f.width = 8 * B),
              (f.height = e * XB),
          ...
          v(B.rows),
          C(B)),
          void 0 !== e && (o($B(null === e ? q : e)), V.clear());
        const A = i();
        const E = n() || F;
        for (const B of Q) G(B, A, E);
      }),
        (L.size = void 0),
        (L.theme = void 0),
        L.rows.clear(),
    ...
    function G(A, e, Q) {
      const g = B.getLine(A, Q);
      !((A) => {
        u.clearRect(0, A * XB, 8 * I().cols, XB);
      })(A),
        ((A, e, Q) => {
          const E = B.getDataView(e, 8);
          const g = A * XB;
          let V = 0;
          while (V < E.byteLength) {
            const A = E.getUint16(V + 0, !0);
            const B = E.getUint16(V + 2, !0);
            const e = b(E, V + 4, Q);
            (V += 8), (u.fillStyle = e), u.fillRect(8 * A, g, 8 * B, XB);
          }
        })(A, g.bg, e),
        ((A, e, Q) => {
          const E = B.getDataView(e, 12);
          const g = A * XB;
          let V = 0;
          while (V < E.byteLength) {
            const A = E.getUint16(V + 0, !0);
            const B = E.getUint32(V + 4, !0);
            const e = b(E, V + 8, Q) || Q.fg;
            (V += 12), (u.fillStyle = e), PB(u, B, 8 * A, g);
          }
        })(A, g.raster_symbols, e),
        ((A, e, Q) => {
          const g = B.getDataView(e, 16);
          const V = document.createDocumentFragment();
          const t = D.children[A];
          let I = 0;
          while (I < g.byteLength) {
            const A = g.getUint16(I + 0, !0);
            const B = g.getUint32(I + 4, !0);
            const e = b(g, I + 8, Q);
            const E = g.getUint8(I + 12);
            I += 16;
            const t = K(B, A, e, !!(32 & E));
            t && V.appendChild(t);
          }
          ((A) => {
            while (A.firstChild) {
              const B = A.firstChild;
              A.removeChild(B), E.push(B);
            }
          })(t),
            t.replaceChildren(V);
        })(A, g.vector_symbols, e),
        ((A, e, Q, E) => {
          const g = B.getDataView(e, 12);
          const V = B.getUint32Array(Q);
          const t = document.createDocumentFragment();
          let I = 0;
          while (I < g.byteLength) {
            const A = g.getUint16(I + 0, !0);
            const B = g.getUint16(I + 2, !0);
            const e = g.getUint16(I + 4, !0);
            const Q = b(g, I + 6, E);
            const C = g.getUint8(I + 10);
            const i = String.fromCodePoint(...V.subarray(B, B + e));
            I += 12;
            const o = document.createElement("span");
            const r = o.style;
            r.setProperty("--offset", A),
              (o.textContent = i),
              Q && (r.color = Q);
            const n = U(C);
            null !== n && (o.className = n), t.appendChild(o);
          }
          d.children[A].replaceChildren(t);
        })(A, g.text, g.codepoints, e);
    }
    function U(A) {
      let B = t.get(A);
      return (
    ...
    function b(A, B, e) {
      const Q = A.getUint8(B);
      if (0 === Q) return null;
      if (1 === Q) return e.fg;
      if (2 === Q) return e.bg;
      if (3 === Q) return e.palette[A.getUint8(B + 1)];
      if (4 === Q) {
        const e = A.getUint32(B, !0);
        let Q = V.get(e);
        if (void 0 === Q) {
          (Q = `rgb(${A.getUint8(B + 1)},${A.getUint8(B + 2)},${A.getUint8(B + 3)})`),
            V.set(e, Q);
        }
        return Q;
      }
      throw new Error(`invalid color tag: ${Q}`);
    }
    function J(A) {
      ...
      if (B < A) {
        ...
        while (B < A) {
          const A = S();
          A.style.setProperty("--row", B), e.appendChild(A), (B += 1);
        }
        d.appendChild(e);
      }
      while (d.children.length > A) {
        const A = d.lastElementChild;
        d.removeChild(A), e.push(A);
      }
    }
    function v(A) {
      let B = D.children.length;
      if (B < A) {
        ...
        while (B < A) {
          const A = Y();
          A.setAttribute("transform", `translate(0 ${B})`),
            e.appendChild(A),
            (B += 1);
        }
        D.appendChild(e);
    ...
    function S() {
      ...
      return (
        void 0 === A &&
          ((A = document.createElement("span")), (A.className = "ap-line")),
        A
      );
    }
    function Y() {
      ...
      return (
        void 0 === A &&
          ((A = document.createElementNS(zB, "g")),
          A.setAttribute("class", "ap-symbol-line")),
        A
      );
    }
    function K(A, B, e, Q) {
      if (
        !((A) => {
          const B = ((A) => {
            const B = `stroke="currentColor" stroke-width="${Ae}" stroke-linejoin="miter" stroke-linecap="square"`;
            const e = `stroke="currentColor" stroke-width="${Ae}" stroke-linejoin="miter" stroke-linecap="butt"`;
            const Q = (A) => `<path d="${A}" fill="none" ${B}/>`;
            const E = 1 / 3;
            const g = 2 / 3;
            switch (A) {
              case 9698:
                return `<path d="M1,1 L1,0 L0,1 Z" fill="currentColor"/>${Q("M1,1 L1,0 L0,1 Z")}`;
              case 9699:
                return `<path d="M0,1 L0,0 L1,1 Z" fill="currentColor"/>${Q("M0,1 L0,0 L1,1 Z")}`;
              case 9700:
                return `<path d="M0,0 L1,0 L0,1 Z" fill="currentColor"/>${Q("M0,0 L1,0 L0,1 Z")}`;
              case 9701:
                return `<path d="M1,0 L1,1 L0,0 Z" fill="currentColor"/>${Q("M1,0 L1,1 L0,0 Z")}`;
              case 9871: {
                const A = 0.17;
                const B = 0.15 / 2;
                const e = 0.2 / 2;
                ...
                const i = Q(e + A);
                const o = (A, B, e, Q) =>
                  `M${A},${e} L${B},${e} L${B},${Q} L${A},${Q} Z`;
                return `<path d="${o(0, E, t, I)} ${o(g, V, t, I)} ${o(0, E, C, i)} ${o(g, V, C, i)}" fill="currentColor"/>`;
              }
              case 129852:
                return `<path d="M0,${g} L0,1 L0.5,1 Z" fill="currentColor"/>${Q(`M0,${g} L0,1 L0.5,1 Z`)}`;
              case 129853:
                return `<path d="M0,${g} L0,1 L1,1 Z" fill="currentColor"/>${Q(`M0,${g} L0,1 L1,1 Z`)}`;
              case 129854:
                return `<path d="M0,${E} L0.5,1 L0,1 Z" fill="currentColor"/>${Q(`M0,${E} L0.5,1 L0,1 Z`)}`;
              case 129855:
                return `<path d="M0,${E} L1,1 L0,1 Z" fill="currentColor"/>${Q(`M0,${E} L1,1 L0,1 Z`)}`;
              case 129856:
                return `<path d="M0,0 L0.5,1 L0,1 Z" fill="currentColor"/>${Q("M0,0 L0.5,1 L0,1 Z")}`;
              case 129857:
                return `<path d="M0,${E} L0,1 L1,1 L1,0 L0.5,0 Z" fill="currentColor"/>${Q(`M0,${E} L0,1 L1,1 L1,0 L0.5,0 Z`)}`;
              case 129858:
                return `<path d="M0,${E} L0,1 L1,1 L1,0 Z" fill="currentColor"/>${Q(`M0,${E} L0,1 L1,1 L1,0 Z`)}`;
              case 129859:
                return `<path d="M0,${g} L0,1 L1,1 L1,0 L0.5,0 Z" fill="currentColor"/>${Q(`M0,${g} L0,1 L1,1 L1,0 L0.5,0 Z`)}`;
              case 129860:
                return `<path d="M0,${g} L0,1 L1,1 L1,0 Z" fill="currentColor"/>${Q(`M0,${g} L0,1 L1,1 L1,0 Z`)}`;
              case 129861:
                return `<path d="M0.5,0 L1,0 L1,1 L0,1 Z" fill="currentColor"/>${Q("M0.5,0 L1,0 L1,1 L0,1 Z")}`;
              case 129862:
                return `<path d="M0,${g} L0,1 L1,1 L1,${E} Z" fill="currentColor"/>${Q(`M0,${g} L0,1 L1,1 L1,${E} Z`)}`;
              case 129863:
                return `<path d="M0.5,1 L1,1 L1,${g} Z" fill="currentColor"/>${Q(`M0.5,1 L1,1 L1,${g} Z`)}`;
              case 129864:
                return `<path d="M0,1 L1,1 L1,${g} Z" fill="currentColor"/>${Q(`M0,1 L1,1 L1,${g} Z`)}`;
              case 129865:
                return `<path d="M0.5,1 L1,1 L1,${E} Z" fill="currentColor"/>${Q(`M0.5,1 L1,1 L1,${E} Z`)}`;
              case 129866:
                return `<path d="M0,1 L1,1 L1,${E} Z" fill="currentColor"/>${Q(`M0,1 L1,1 L1,${E} Z`)}`;
              case 129867:
                return `<path d="M0.5,1 L1,0 L1,1 Z" fill="currentColor"/>${Q("M0.5,1 L1,0 L1,1 Z")}`;
              case 129868:
                return `<path d="M0,0 L0.5,0 L1,${E} L1,1 L0,1 Z" fill="currentColor"/>${Q(`M0,0 L0.5,0 L1,${E} L1,1 L0,1 Z`)}`;
              case 129869:
                return `<path d="M0,0 L0,1 L1,1 L1,${E} Z" fill="currentColor"/>${Q(`M0,0 L0,1 L1,1 L1,${E} Z`)}`;
              case 129870:
                return `<path d="M0,0 L0.5,0 L1,${g} L1,1 L0,1 Z" fill="currentColor"/>${Q(`M0,0 L0.5,0 L1,${g} L1,1 L0,1 Z`)}`;
              case 129871:
                return `<path d="M0,0 L1,${g} L1,1 L0,1 Z" fill="currentColor"/>${Q(`M0,0 L1,${g} L1,1 L0,1 Z`)}`;
              case 129872:
                return `<path d="M0,0 L0.5,0 L1,1 L0,1 Z" fill="currentColor"/>${Q("M0,0 L0.5,0 L1,1 L0,1 Z")}`;
              case 129873:
                return `<path d="M0,${E} L1,${g} L1,1 L0,1 Z" fill="currentColor"/>${Q(`M0,${E} L1,${g} L1,1 L0,1 Z`)}`;
              case 129874:
                return `<path d="M0,${g} L0,0 L1,0 L1,1 L0.5,1 Z" fill="currentColor"/>${Q(`M0,${g} L0,0 L1,0 L1,1 L0.5,1 Z`)}`;
              case 129875:
                return `<path d="M0,${g} L0,0 L1,0 L1,1 Z" fill="currentColor"/>${Q(`M0,${g} L0,0 L1,0 L1,1 Z`)}`;
              case 129876:
                return `<path d="M0,${E} L0,0 L1,0 L1,1 L0.5,1 Z" fill="currentColor"/>${Q(`M0,${E} L0,0 L1,0 L1,1 L0.5,1 Z`)}`;
              case 129877:
                return `<path d="M0,${E} L0,0 L1,0 L1,1 Z" fill="currentColor"/>${Q(`M0,${E} L0,0 L1,0 L1,1 Z`)}`;
              case 129878:
                return `<path d="M0,0 L1,0 L1,1 L0.5,1 Z" fill="currentColor"/>${Q("M0,0 L1,0 L1,1 L0.5,1 Z")}`;
              case 129879:
                return `<path d="M0,${E} L0.5,0 L0,0 Z" fill="currentColor"/>${Q(`M0,${E} L0.5,0 L0,0 Z`)}`;
              case 129880:
                return `<path d="M0,0 L1,0 L0,${E} Z" fill="currentColor"/>${Q(`M0,0 L1,0 L0,${E} Z`)}`;
              case 129881:
                return `<path d="M0,0 L0.5,0 L0,${g} Z" fill="currentColor"/>${Q(`M0,0 L0.5,0 L0,${g} Z`)}`;
              case 129882:
                return `<path d="M0,0 L1,0 L0,${g} Z" fill="currentColor"/>${Q(`M0,0 L1,0 L0,${g} Z`)}`;
              case 129883:
                return `<path d="M0,0 L0.5,0 L0,1 Z" fill="currentColor"/>${Q("M0,0 L0.5,0 L0,1 Z")}`;
              case 129884:
                return `<path d="M0,0 L1,0 L1,${E} L0,${g} Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${E} L0,${g} Z`)}`;
              case 129885:
                return `<path d="M0,0 L1,0 L1,${g} L0.5,1 L0,1 Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${g} L0.5,1 L0,1 Z`)}`;
              case 129886:
                return `<path d="M0,0 L1,0 L1,${g} L0,1 Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${g} L0,1 Z`)}`;
              case 129887:
                return `<path d="M0,0 L1,0 L1,${E} L0.5,1 L0,1 Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${E} L0.5,1 L0,1 Z`)}`;
              case 129888:
                return `<path d="M0,0 L1,0 L1,${E} L0,1 Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${E} L0,1 Z`)}`;
              case 129889:
                return `<path d="M0,0 L1,0 L0.5,1 L0,1 Z" fill="currentColor"/>${Q("M0,0 L1,0 L0.5,1 L0,1 Z")}`;
              case 129890:
                return `<path d="M0.5,0 L1,0 L1,${E} Z" fill="currentColor"/>${Q(`M0.5,0 L1,0 L1,${E} Z`)}`;
              case 129891:
                return `<path d="M0,0 L1,0 L1,${E} Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${E} Z`)}`;
              case 129892:
                return `<path d="M0.5,0 L1,0 L1,${g} Z" fill="currentColor"/>${Q(`M0.5,0 L1,0 L1,${g} Z`)}`;
              case 129893:
                return `<path d="M0,0 L1,0 L1,${g} Z" fill="currentColor"/>${Q(`M0,0 L1,0 L1,${g} Z`)}`;
              case 129894:
                return `<path d="M0.5,0 L1,0 L1,1 Z" fill="currentColor"/>${Q("M0.5,0 L1,0 L1,1 Z")}`;
              case 129895:
                return `<path d="M0,${E} L0,0 L1,0 L1,${g} Z" fill="currentColor"/>${Q(`M0,${E} L0,0 L1,0 L1,${g} Z`)}`;
              case 129896:
                return `<path fill-rule="evenodd" d="M0,0 L1,0 L1,1 L0,1 Z M0,0 L0,1 L0.5,0.5 Z" fill="currentColor"/><path d="M0,0 L1,0 M0,1 L1,1 M1,0 L1,1" fill="none" ${B}/><path d="M0,0 L0.5,0.5 M0,1 L0.5,0.5" fill="none" ${e}/>`;
              case 129897:
                return `<path fill-rule="evenodd" d="M0,0 L1,0 L1,1 L0,1 Z M0,0 L1,0 L0.5,0.5 Z" fill="currentColor"/><path d="M0,0 L0,1 M1,0 L1,1 M0,1 L1,1" fill="none" ${B}/><path d="M0,0 L0.5,0.5 M1,0 L0.5,0.5" fill="none" ${e}/>`;
              case 129898:
                return `<path fill-rule="evenodd" d="M0,0 L1,0 L1,1 L0,1 Z M1,0 L1,1 L0.5,0.5 Z" fill="currentColor"/><path d="M0,0 L1,0 M0,1 L1,1 M0,0 L0,1" fill="none" ${B}/><path d="M1,0 L0.5,0.5 M1,1 L0.5,0.5" fill="none" ${e}/>`;
              case 129899:
                return `<path fill-rule="evenodd" d="M0,0 L1,0 L1,1 L0,1 Z M0,1 L1,1 L0.5,0.5 Z" fill="currentColor"/><path d="M0,0 L1,0 M0,0 L0,1 M1,0 L1,1" fill="none" ${B}/><path d="M0,1 L0.5,0.5 M1,1 L0.5,0.5" fill="none" ${e}/>`;
              case 129900:
                return `<path d="M0,0 L0,1 L0.5,0.5 Z" fill="currentColor"/>${Q("M0,0 L0,1 L0.5,0.5 Z")}`;
              case 57520:
          ...
          if (g.has(A)) return !0;
          const e = `sym-${A}`;
          const Q = document.createElementNS(zB, "symbol");
          return (
            Q.setAttribute("id", e),
            Q.setAttribute("viewBox", "0 0 1 1"),
            Q.setAttribute("preserveAspectRatio", "none"),
            Q.setAttribute("overflow", "visible"),
            (Q.innerHTML = B),
            w.appendChild(Q),
            g.add(A),
            !0
      ...
      const C = (() => {
        let A = E.pop();
        void 0 === A && (A = document.createElementNS(zB, "use"));
        return A;
      })();
      return (
        C.setAttribute("href", `#sym-${A}`),
        C.setAttribute("x", t),
        C.setAttribute("y", 0),
        C.setAttribute("width", I),
        C.setAttribute("height", "1"),
        e ? C.style.setProperty("color", e) : C.style.removeProperty("color"),
        Q ? C.classList.add("ap-blink") : C.classList.remove("ap-blink"),
        C
      );
    }
    return (
      JA(() => {
        !(() => {
          if (((u = f.getContext("2d")), !u))
            throw new Error("2D ctx not available");
          const { cols: A, rows: B } = I();
          (f.width = 8 * A),
            (f.height = B * XB),
          ...
          (q = ((A) => {
            ...
            const e = B.getPropertyValue("--term-color-foreground");
            const Q = B.getPropertyValue("--term-color-background");
            const E = [];
            for (let A = 0; A < 16; A++) {
              const e = B.getPropertyValue(`--term-color-${A}`);
              if (void 0 === e)
                throw new Error(`--term-color-${A} has not been defined`);
              E[A] = e;
            }
            return { foreground: e, background: Q, palette: E };
          })(l)),
          ...
          J(I().rows),
          v(I().rows),
          B.addEventListener("vtUpdate", R);
      }),
      vA(() => {
        B.removeEventListener("vtUpdate", R),
          clearInterval(k),
      ...
      NA(() => {
        A.blinking && void 0 === k
          ? (k = setInterval(M, 600))
          : (clearInterval(k), (k = void 0), s(!0));
      }),
      NA(() => {
        a(), p.visible && (L.rows.add(p.row), m());
      }),
      (() => {
        const A = jB.cloneNode(!0);
        const B = A.firstChild;
        const e = B.nextSibling;
        const Q = e.firstChild;
        const E = Q.nextSibling;
        const g = e.nextSibling;
        "function" === typeof l ? lB(l, A) : (l = A);
        "function" === typeof f ? lB(f, B) : (f = B);
        "function" === typeof h ? lB(h, e) : (h = e);
        "function" === typeof w ? lB(w, Q) : (w = Q);
        "function" === typeof D ? lB(D, E) : (D = E);
        return (
          "function" === typeof d ? lB(d, g) : (d = g),
          mA(
            (B) => {
              const Q = c();
              const E = `0 0 ${I().cols} ${I().rows}`;
              const V = !!n();
              const t = !!n();
              return (
                (B._v$ = cB(A, Q, B._v$)),
                E !== B._v$2 && sB(e, "viewBox", (B._v$2 = E)),
                V !== B._v$3 && e.classList.toggle("ap-blink", (B._v$3 = V)),
                t !== B._v$4 && g.classList.toggle("ap-blink", (B._v$4 = t)),
                B
              );
            },
  ...
  function PB(A, B, e, Q) {
    ...
    switch (B) {
      case 9600:
        ...
        break;
      case 9601:
        A.fillRect(e, Q + 21, 8, 3);
        break;
      case 9602:
        A.fillRect(e, Q + 18, 8, 6);
        break;
      case 9603:
        A.fillRect(e, Q + 15, 8, 9);
        break;
      case 9604:
        A.fillRect(e, Q + E, 8, E);
        break;
      case 9605:
        A.fillRect(e, Q + 9, 8, 15);
        break;
      case 9606:
        A.fillRect(e, Q + 6, 8, 18);
        break;
      case 9607:
        A.fillRect(e, Q + 3, 8, 21);
        break;
      case 9608:
        A.fillRect(e, Q, 8, XB);
        break;
      case 9632:
        A.fillRect(e, Q + 6, 8, 12);
        break;
      case 9609:
        A.fillRect(e, Q, 7, XB);
        break;
      ...
      case 9615:
        ...
        break;
      case 9616:
        A.fillRect(e + 4, Q, 4, XB);
        break;
      case 9617:
        A.save(), (A.globalAlpha = 0.25), A.fillRect(e, Q, 8, XB), A.restore();
        break;
      case 9618:
        A.save(), (A.globalAlpha = 0.5), A.fillRect(e, Q, 8, XB), A.restore();
        break;
      case 9619:
        A.save(), (A.globalAlpha = 0.75), A.fillRect(e, Q, 8, XB), A.restore();
        break;
      case 9620:
        A.fillRect(e, Q, 8, 3);
        break;
      case 9621:
        A.fillRect(e + 7, Q, 1, XB);
        break;
      case 9622:
        A.fillRect(e, Q + E, 4, E);
        break;
      case 9623:
        A.fillRect(e + 4, Q + E, 4, E);
        break;
      case 9624:
        A.fillRect(e, Q, 4, E);
        break;
      case 9625:
        A.fillRect(e, Q, 4, XB), A.fillRect(e + 4, Q + E, 4, E);
        break;
      case 9626:
        A.fillRect(e, Q, 4, E), A.fillRect(e + 4, Q + E, 4, E);
        break;
      case 9627:
        A.fillRect(e, Q, 8, E), A.fillRect(e, Q + E, 4, E);
        break;
      case 9628:
        A.fillRect(e, Q, 8, E), A.fillRect(e + 4, Q + E, 4, E);
        break;
      case 9629:
        A.fillRect(e + 4, Q, 4, E);
        break;
      case 9630:
        A.fillRect(e + 4, Q, 4, E), A.fillRect(e, Q + E, 4, E);
        break;
      case 9631:
        A.fillRect(e + 4, Q, 4, XB), A.fillRect(e, Q + E, 4, E);
        break;
      case 129792:
        A.fillRect(e, Q, 4, 8);
        break;
      case 129793:
        A.fillRect(e + 4, Q, 4, 8);
        break;
      case 129794:
        A.fillRect(e, Q, 8, 8);
        break;
      case 129795:
        A.fillRect(e, Q + 8, 4, 8);
        break;
      case 129796:
        A.fillRect(e, Q, 4, 8), A.fillRect(e, Q + 8, 4, 8);
        break;
      case 129797:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 8, 4, 8);
        break;
      case 129798:
        A.fillRect(e, Q, 8, 8), A.fillRect(e, Q + 8, 4, 8);
        break;
      case 129799:
        A.fillRect(e + 4, Q + 8, 4, 8);
        break;
      case 129800:
        A.fillRect(e, Q, 4, 8), A.fillRect(e + 4, Q + 8, 4, 8);
        break;
      case 129801:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e + 4, Q + 8, 4, 8);
        break;
      case 129802:
        A.fillRect(e, Q, 8, 8), A.fillRect(e + 4, Q + 8, 4, 8);
        break;
      case 129803:
        A.fillRect(e, Q + 8, 8, 8);
        break;
      case 129804:
        A.fillRect(e, Q, 4, 8), A.fillRect(e, Q + 8, 8, 8);
        break;
      case 129805:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 8, 8, 8);
        break;
      case 129806:
        A.fillRect(e, Q, 8, 8), A.fillRect(e, Q + 8, 8, 8);
        break;
      case 129807:
        A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129808:
        A.fillRect(e, Q, 4, 8), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129809:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129810:
        A.fillRect(e, Q, 8, 8), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129811:
        A.fillRect(e, Q + 8, 4, 16);
        break;
      case 129812:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 8, 4, 16);
        break;
      case 129813:
        A.fillRect(e, Q, 8, 8), A.fillRect(e, Q + 8, 4, 16);
        break;
      case 129814:
        A.fillRect(e + 4, Q + 8, 4, 8), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129815:
        A.fillRect(e, Q, 4, 8),
          A.fillRect(e + 4, Q + 8, 4, 8),
        ...
        break;
      case 129816:
        A.fillRect(e + 4, Q, 4, 16), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129817:
        A.fillRect(e, Q, 8, 8),
          A.fillRect(e + 4, Q + 8, 4, 8),
        ...
        break;
      case 129818:
        A.fillRect(e, Q + 8, 8, 8), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129819:
        A.fillRect(e, Q, 4, 24), A.fillRect(e + 4, Q + 8, 4, 8);
        break;
      case 129820:
        A.fillRect(e + 4, Q, 4, 8),
          A.fillRect(e, Q + 8, 8, 8),
        ...
        break;
      case 129821:
        A.fillRect(e, Q, 8, 16), A.fillRect(e, Q + 16, 4, 8);
        break;
      case 129822:
        A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129823:
        A.fillRect(e, Q, 4, 8), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129824:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129825:
        A.fillRect(e, Q, 8, 8), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129826:
        A.fillRect(e, Q + 8, 4, 8), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129827:
        A.fillRect(e, Q, 4, 16), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129828:
        A.fillRect(e + 4, Q, 4, 8),
          A.fillRect(e, Q + 8, 4, 8),
      ...
      case 129829:
        ...
        break;
      case 129830:
        A.fillRect(e + 4, Q + 8, 4, 16);
        break;
      case 129831:
        A.fillRect(e, Q, 4, 8), A.fillRect(e + 4, Q + 8, 4, 16);
        break;
      case 129832:
        A.fillRect(e, Q, 8, 8), A.fillRect(e + 4, Q + 8, 4, 16);
        break;
      case 129833:
        A.fillRect(e, Q + 8, 8, 8), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129834:
        A.fillRect(e, Q, 4, 16), A.fillRect(e + 4, Q + 8, 4, 16);
        break;
      case 129835:
        A.fillRect(e + 4, Q, 4, 8),
          A.fillRect(e, Q + 8, 8, 8),
        ...
        break;
      case 129836:
        A.fillRect(e, Q, 8, 16), A.fillRect(e + 4, Q + 16, 4, 8);
        break;
      case 129837:
        A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129838:
        A.fillRect(e, Q, 4, 8), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129839:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129840:
        A.fillRect(e, Q, 8, 8), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129841:
        A.fillRect(e, Q + 8, 4, 8), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129842:
        A.fillRect(e, Q, 4, 16), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129843:
        A.fillRect(e + 4, Q, 4, 8),
          A.fillRect(e, Q + 8, 4, 8),
      ...
      case 129844:
        ...
        break;
      case 129845:
        A.fillRect(e + 4, Q + 8, 4, 8), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129846:
        A.fillRect(e, Q, 4, 8),
          A.fillRect(e + 4, Q + 8, 4, 8),
        ...
        break;
      case 129847:
        A.fillRect(e + 4, Q, 4, 16), A.fillRect(e, Q + 16, 8, 8);
        break;
      case 129848:
        A.fillRect(e, Q, 8, 8),
          A.fillRect(e + 4, Q + 8, 4, 8),
      ...
      case 129850:
        ...
        break;
      case 129851:
        A.fillRect(e + 4, Q, 4, 8), A.fillRect(e, Q + 8, 8, 16);
    }
  }
  const Ae = 0.05;
  const Be = 9.0375 / 20;
  const ee = new Set([57520, 57521, 57522, 57523]);
  const Qe = 0.02;
  const Ee = {
    foreground: "black",
    background: "black",
  ...
  const we = rB('<span class="ap-tooltip">Unmute (m)</span>', 2);
  const De = rB('<span class="ap-tooltip">Mute (m)</span>', 2);
  const ye = rB(
  ...
  function pe(A) {
    let B = Math.floor(A);
    const e = Math.floor(B / 86400);
    B %= 86400;
    const Q = Math.floor(B / 3600);
    B %= 3600;
  ...
  const Fe = (A) => {
    ...
    const e = () =>
      "number" === typeof A.currentTime ? pe(A.currentTime) : "--:--";
    const Q = () =>
      "number" === typeof A.remainingTime ? `-${pe(A.remainingTime)}` : e();
    const E = GA(() =>
    ...
    const g = (A) => {
      ...
      const Q = A.clientX - e.left;
      return `${100 * Math.max(0, Q / B)}%`;
    };
    const [V, t] = MA(!1);
    const I = ((A, B) => {
      let e = !0;
      return function () {
        if (e) {
          e = !1;
          for (let Q = arguments.length, E = new Array(Q), g = 0; g < Q; g++)
            E[g] = arguments[g];
          A.apply(this, E), setTimeout(() => (e = !0), B);
        }
      };
    })(A.onSeekClick, 50);
    const C = (B) => {
      B._marker ||
        ...
        B.ctrlKey ||
        0 !== B.button ||
        (t(!0), A.onSeekClick(g(B)));
    };
    const i = (A) => {
      A.altKey || A.shiftKey || A.metaKey || A.ctrlKey || (V() && I(g(A)));
    };
    const o = () => {
      t(!1);
    };
    return (
      ...
      (() => {
        ...
        const c = A.ref;
        return (
          "function" === typeof c ? lB(c, g) : (A.ref = g),
          fB(
            g,
            gB(IB, {
              get when() {
          ...
          fB(
            ...
            gB(IB, {
              ...
              get children() {
                const e = he.cloneNode(!0);
                const Q = e.firstChild.nextSibling;
                return (
                  (e.$$mousemove = i),
                  (e.$$mousedown = C),
                  fB(
                    ...
                    gB(tB, {
                      ...
                      children: (e, Q) =>
                        (() => {
                          ...
                          const g = E.firstChild;
                          const V = g.nextSibling;
                          let t;
                          return (
                            (E.$$mousedown = (A) => {
                              A._marker = !0;
                            ...
                            mA(
                              (B) => {
                                const Q = ((B) =>
                                  `${(B[0] / A.duration) * 100}%`)(e);
                                const V = !!((B) =>
                                  "number" === typeof A.currentTime &&
                                  B[0] <= A.currentTime)(e);
                                return (
                                  Q !== B._v$ &&
                                    E.style.setProperty("left", (B._v$ = Q)),
                                  V !== B._v$2 &&
                                    g.classList.toggle(
                                      "ap-marker-past",
                                      (B._v$2 = V)
                  ...
                  mA((B) =>
                    cB(Q, { transform: `scaleX(${A.progress || 0}` }, B)
                  ),
                  e
                );
              },
          ...
          aB(r, "click", B(A.onHelpClick)),
          fB(r, gB(Ce, {}), n),
          aB(s, "click", B(A.onFullscreenClick)),
          fB(s, gB(ae, {}), a),
          fB(s, gB(te, {}), a),
          mA(() => g.classList.toggle("ap-seekable", !!A.isSeekable)),
          g
        );
      })()
    );
  };
  nB(["click", "mousedown", "mousemove"]);
  const Re = rB(
    '<div class="ap-overlay ap-overlay-error"><span>💥</span></div>',
    4
  );
  const Me = (_A) => Re.cloneNode(!0);
  const me = rB(
    '<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
    4
  );
  const Ne = (_A) => me.cloneNode(!0);
  const Ge = rB(
  ...
  nB(["click"]);
  const ve = rB("<li><kbd>space</kbd> - pause / resume</li>", 4);
  const Se = rB(
  ...
  const Oe = rB("<li><kbd>m</kbd> - mute / unmute audio</li>", 4);
  const He = rB(
  ...
  const Ze = (A) =>
    (() => {
      const B = He.cloneNode(!0);
      const e = B.firstChild;
      const Q = e.firstChild.firstChild.nextSibling;
      const E = Q.firstChild;
      const g = E.nextSibling;
      let V;
      return (
        aB(
  ...
  nB(["click"]);
  const We = rB('<div class="ap-wrapper" tabindex="-1"><div></div></div>', 4);
  const je = (A) => {
    const B = A.logger;
    const e = A.core;
    const Q = A.autoPlay;
    ...
    const V = A.bordersW;
    const t = A.bordersH;
    const I = A.theme ?? "auto/asciinema";
    const C = "auto/" === I.slice(0, 5);
    const i = C ? I.slice(5) : I;
    const [o, r] = vB({
      containerW: 0,
      containerH: 0,
      isPausable: !0,
    ...
    const [N, G] = MA(!1);
    const [U, b] = MA(null);
    const J = GA(() => k().cols || 80);
    const v = GA(() => k().rows || 24);
    const S = () => (!1 === A.controls ? 0 : 32);
    let Y;
    let K;
    let T;
    let x;
    ...
    const z = (A) => {
      const { isPausable: B, isSeekable: e } = A;
      r({ isPausable: B, isSeekable: e }), Z();
    };
    const X = (A) => {
      UA(() => {
        void 0 !== A.duration && L(A.duration),
          void 0 !== A.markers && R(A.markers),
          void 0 !== A.hasAudio && c(!A.hasAudio && void 0),
          void 0 !== A.size && q(A.size),
          void 0 !== A.theme && b(A.theme);
      });
    };
    const _ = () => {
      d(null);
    ...
    e.addEventListener("ready", z),
      e.addEventListener("metadata", X),
      e.addEventListener("play", _),
      e.addEventListener("playing", $),
      e.addEventListener("idle", P),
      e.addEventListener("loading", AA),
      e.addEventListener("offline", BA),
      e.addEventListener("muted", eA),
      e.addEventListener("ended", EA),
      e.addEventListener("errored", gA),
      e.addEventListener("seeked", VA);
    const tA = () => {
      (H = new ResizeObserver(
        ((A, B) => {
          ...
          return function () {
            for (let Q = arguments.length, E = new Array(Q), g = 0; g < Q; g++)
              E[g] = arguments[g];
            clearTimeout(e), (e = setTimeout(() => A.apply(this, E), B));
          };
        })((_A) => {
          r({ containerW: T.offsetWidth, containerH: T.offsetHeight }),
            T.dispatchEvent(new CustomEvent("resize", { detail: { el: x } }));
        }, 10)
      )),
        H.observe(T);
    };
    JA(async () => {
      B.info("view: mounted"),
        B.debug("view: font measurements", { charW: E, charH: g }),
        tA(),
        r({ containerW: T.offsetWidth, containerH: T.offsetHeight });
    }),
      vA(() => {
        e.removeEventListener("ready", z),
          e.removeEventListener("metadata", X),
          e.removeEventListener("play", _),
          e.removeEventListener("playing", $),
          e.removeEventListener("idle", P),
          e.removeEventListener("loading", AA),
          e.removeEventListener("offline", BA),
          e.removeEventListener("muted", eA),
          e.removeEventListener("ended", EA),
          e.removeEventListener("errored", gA),
          e.removeEventListener("seeked", VA),
          e.stop(),
          cA(),
          H.disconnect();
      });
    const IA = GA(() => {
      ...
      const e = g * v() + t;
      let Q = A.fit ?? "width";
      if ("both" === Q || o.isFullscreen) {
        Q = o.containerW / (o.containerH - S()) > B / e ? "height" : "width";
      }
      if (!1 === Q || "none" === Q) return {};
      if ("width" === Q) {
        const A = o.containerW / B;
        return { scale: A, width: o.containerW, height: e * A + S() };
      }
      if ("height" === Q) {
        const A = (o.containerH - S()) / e;
        return { scale: A, width: B * A, height: o.containerH };
      }
      throw new Error(`unsupported fit mode: ${Q}`);
    });
    const CA = () => {
      r(
        "isFullscreen",
    ...
    const rA = (A) => {
      if (!(A.altKey || A.metaKey || A.ctrlKey)) {
        if (" " === A.key) e.togglePlay();
        else if ("," === A.key) e.step(-1).then(lA);
        else if ("." === A.key) e.step().then(lA);
        else if ("f" === A.key) iA();
        else if ("m" === A.key) wA();
        else if ("[" === A.key) e.seek({ marker: "prev" });
        else if ("]" === A.key) e.seek({ marker: "next" });
        else if (A.key.charCodeAt(0) >= 48 && A.key.charCodeAt(0) <= 57) {
          const B = (A.key.charCodeAt(0) - 48) / 10;
          e.seek(`${100 * B}%`);
        } else if ("?" === A.key) oA();
        else if ("ArrowLeft" === A.key)
          A.shiftKey ? e.seek("<<<") : e.seek("<<");
    ...
    const _aA = () => {
      K = setInterval(lA, 100);
    };
    const _cA = () => {
      clearInterval(K);
    };
    const _lA = async () => {
      const A = await e.getCurrentTime();
      const B = await e.getRemainingTime();
      const Q = await e.getProgress();
      r({ currentTime: A, remainingTime: B, progress: Q });
    };
    const fA = (A) => {
      clearTimeout(Y), A && (Y = setTimeout(() => fA(!1), 2e3)), m(A);
    };
    const uA = GA(() => (C ? U() : null));
    const dA = () => {
      j.then(() => e.play());
    };
    const hA = () => {
    ...
    const yA = (() => {
      const B = We.cloneNode(!0);
      const Q = B.firstChild;
      "function" === typeof T ? lB(T, B) : (T = B),
        B.addEventListener("webkitfullscreenchange", CA),
        B.addEventListener("fullscreenchange", CA),
        (B.$$mousemove = nA),
        (B.$$keydown = rA);
      return (
        "function" === typeof x ? lB(x, Q) : (x = Q),
        (Q.$$mousemove = () => fA(!0)),
        Q.addEventListener("mouseleave", sA),
        fB(
          Q,
          gB(_B, {
            get cols() {
          ...
          gB(IB, {
            ...
            get children() {
              return gB(Fe, {
                ...
                onPlayClick: hA,
                onFullscreenClick: iA,
                onHelpClick: oA,
                onSeekClick: DA,
                onMuteClick: wA,
                ref(A) {
                  "function" === typeof O ? O(A) : (O = A);
                },
              });
            },
          }),
        ...
        mA(
          (e) => {
            const E = !!(!0 === A.controls || ("auto" === A.controls && M()));
            const g = `ap-player ap-default-term-ff asciinema-player-theme-${i}`;
            const V = (() => {
              const B = {};
              (!1 !== A.fit && "none" !== A.fit) ||
              ...
              const e = IA();
              void 0 !== e.width &&
                ((B.width = `${e.width}px`), (B.height = `${e.height}px`)),
                void 0 !== A.terminalFontFamily &&
                  (B["--term-font-family"] = A.terminalFontFamily);
              const Q = uA();
              return (
                Q &&
                  ((B["--term-color-foreground"] = Q.foreground),
                  (B["--term-color-background"] = Q.background)),
                B
              );
            })();
            let t;
            let I;
            return (
              E !== e._v$ && B.classList.toggle("ap-hud", (e._v$ = E)),
              g !== e._v$2 &&
                ((t = Q),
                null == (I = e._v$2 = g)
                  ? t.removeAttribute("class")
                  : (t.className = I)),
              (e._v$3 = cB(Q, V, e._v$3)),
              e
            );
          },
  ...
  function ze(A, B) {
    ...
    const Q = ((A, B) => {
      ...
      (E.className = "ap-default-term-ff"),
        ...
        void 0 !== A && E.style.setProperty("--term-font-family", A);
      const g = document.createElement("div");
      (g.className = "ap-term"),
        (g.style.width = `${e}ch`),
        (g.style.height = `${Q * (B ?? 1.3333333333)}em`),
        (g.style.fontSize = "100%"),
        E.appendChild(g),
        document.body.appendChild(E);
      const V = {
        charW: g.clientWidth / e,
        charH: g.clientHeight / Q,
        bordersW: g.offsetWidth - g.clientWidth,
        bordersH: g.offsetHeight - g.clientHeight,
      };
      return document.body.removeChild(E), V;
    })(e.terminalFontFamily, e.terminalLineHeight);
    const E = {
      core: A,
      logger: e.logger,
      cols: e.cols,
      ...
      terminalLineHeight: e.terminalLineHeight,
      theme: e.theme,
      ...Q,
    };
    let g;
    const V = ((A, B, e, Q = {}) => {
      ...
      return (
        RA((Q) => {
          (E = Q),
            B === document ? A() : fB(B, A(), B.firstChild ? null : void 0, e);
        }, Q.owner),
        () => {
          E(), (B.textContent = "");
        }
    ...
    return { el: g, dispose: V };
  }
  nB(["keydown", "mousemove"]);
  const Xe = [
    "audioUrl",
    "autoPlay",
    "autoplay",
  ...
  return (
    (A.create = (A, B) => {
        ...
        ((A) => {
          ...
          const e = Object.fromEntries(
            Object.entries(A).filter((A) => {
              const [B] = A;
              return Xe.includes(B);
            })
          );
          return (e.autoPlay ??= e.autoplay), (e.speed ??= 1), { ...e, ...B };
        })(Q, { logger: E })
      );
      const { el: V, dispose: t } = ze(
        g,
        B,
        ((A) => {
          const B =
          ...
          return (
            (e.autoPlay ??= e.autoplay), (e.controls ??= "auto"), { ...e, ...B }
          );
        })(Q, { logger: E })
      );
      const I = g.init();
      const C = {
        el: V,
        dispose: t,
        getCurrentTime: () => I.then(g.getCurrentTime.bind(g)),
        getDuration: () => I.then(g.getDuration.bind(g)),
        play: () => I.then(g.play.bind(g)),
        pause: () => I.then(g.pause.bind(g)),
        seek: (A) => I.then(() => g.seek(A)),
        addEventListener: (A, B) => g.addEventListener(A, B.bind(C)),
      };
      return C;
    }),
    A
