...
export default function JsonViewer() {
  ...
  const _title = args?.title || "JSON Viewer";
  const expandDepth = Number.parseInt(args?.expandDepth || "2", 10);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: error is intentionally excluded to avoid recalculating on error state changes
            ...
            return (
              <Box key={actualIdx}>
                <Text inverse={isSelected}>
                  ...
                  <Text color={isExpandable ? "cyan" : "gray"}>
                    {expandIcon}{" "}
                  </Text>
                  {node.key !== null && (
                    <>
